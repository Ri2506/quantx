    ...
    <div className="min-h-screen w-full text-text-primary">
      ...
      <nav className="fixed top-0 z-50 w-full border-b border-border/60 bg-background-primary/80 backdrop-blur-xl">
        <div className="container mx-auto flex items-center justify-between px-6 py-4">
          ...
          <div className="hidden flex-col gap-2 text-sm text-text-secondary md:flex">
            ...
            <div className="flex flex-wrap items-center gap-x-4 gap-y-2 text-xs font-semibold uppercase tracking-wide text-text-muted">
              <span className="text-text-muted/70">App</span>
              <Link href="/dashboard" className="transition hover:text-accent">
                Dashboard
              </Link>
              <Link href="/signals" className="transition hover:text-accent">
                Signals
              </Link>
              ...
              <Link href="/trades" className="transition hover:text-accent">
                Trades
              </Link>
              <Link href="/analytics" className="transition hover:text-accent">
                Analytics
              </Link>
              <Link href="/settings" className="transition hover:text-accent">
                Settings
              </Link>
              <Link href="/assistant" className="transition hover:text-accent">
                Assistant
              </Link>
            </div>
          </div>
      ...
      <section className="relative pb-12">
        <div className="container mx-auto px-6">
          <motion.div
            ...
            className="mb-8 rounded-2xl border border-accent/40 bg-gradient-to-r from-accent/15 via-primary/10 to-accent/10 p-5 md:p-6"
          >
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
              <div>
                <p className="text-xs font-semibold uppercase tracking-wide text-accent">
                  New: SwingAI Finance Intelligence
                </p>
                <h3 className="mt-1 text-xl font-semibold text-text-primary">
                  Chat with Finance-Only Market Intelligence
                </h3>
                <p className="mt-1 text-sm text-text-secondary">
                  Ask about Indian and global markets, trading setups, and financial news with source-backed replies.
                </p>
              </div>
