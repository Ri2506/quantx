...
export default function AdminPaymentsPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      default:
        return 'bg-background-elevated/60 text-text-muted'
    }
  }
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-text-muted mt-1">Last {statsPeriod} days</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-text-muted mt-1">Successful payments</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-text-muted mt-1">Failed attempts</p>
            </div>
        ...
        >
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-text-muted mt-1">{stats?.refunds_count || 0} refunds</p>
            </div>
      ...
      <div className="app-panel p-4">
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <button
            ...
            className="px-4 py-2.5 bg-background-elevated/80 hover:bg-background-elevated rounded-lg text-text-secondary transition-colors flex items-center gap-2"
          >
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-border/50">
                {payments.map((payment) => (
                  <tr key={payment.id} className="hover:bg-background-elevated/80/30 transition-colors">
                    ...
                    <td className="px-4 py-4">
                      ...
                      <p className="text-text-muted text-xs capitalize">{payment.billing_period}</p>
                    </td>
                    <td className="px-4 py-4">
                    ...
                    <td className="px-4 py-4">
                      <code className="text-text-secondary text-xs bg-background-elevated/80 px-2 py-1 rounded">
