  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      <motion.button
        ...
        className="relative p-2 rounded-xl bg-background-elevated border border-border/50 hover:border-border/80 transition-all"
      >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 mt-2 w-96 bg-background-elevated border border-border/50 rounded-2xl shadow-2xl z-50"
          >
            {/* Header */}
