    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="app-panel shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden">
              {/* Header */}
                ...
                <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-12 pr-4 py-3 bg-background-elevated border border-border/50 rounded-xl text-text-primary placeholder:text-text-muted focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
                      />
                    </div>

                    {/* Search Results */}
                    {searchQuery && (
                      <div className="mt-2 max-h-40 overflow-y-auto bg-background-elevated border border-border/50 rounded-xl divide-y divide-border/50">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                        ...
                        <button
                          ...
                          className={`p-3 rounded-xl border font-medium transition-all ${
                            direction === 'BUY'
                              ...
                              : 'bg-background-elevated border-border/50 text-text-secondary hover:border-border/80'
                          }`}
                        >
                    ...
                    <div>
                      ...
                      <select
                        {...register('orderType')}
                        className="w-full px-4 py-3 bg-background-elevated border border-border/50 rounded-xl text-text-primary focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
                      >
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        step="0.05"
                        placeholder="₹ 0.00"
                        className="w-full px-4 py-3 bg-background-elevated border border-border/50 rounded-xl text-text-primary font-mono placeholder:text-text-muted focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20"
                      />
                    </div>
                  ...
                  <div className="flex gap-3 pt-4">
                    <button
                      type="button"
                      onClick={onClose}
                      className="flex-1 px-6 py-3 bg-background-elevated border border-border/50 rounded-xl text-text-primary font-medium hover:border-border/80 transition-all"
                    >
                      Cancel
                    </button>
                    <motion.button
