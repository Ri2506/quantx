...
export default function TradeCalendar({ data }: TradeCalendarProps) {
  ...
  const getColor = (pnl: number) => {
    if (pnl === 0) return 'bg-background-elevated/80'
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2 text-xs">
          ...
          <div className="flex gap-1">
            <div className="w-3 h-3 rounded-sm bg-background-elevated/80" />
      ...
      <div className="relative">
        ...
        {hoveredDay && hoveredPosition && (
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            className="fixed z-50 p-3 bg-background-elevated border border-border/50 rounded-xl shadow-2xl pointer-events-none"
            style={{
