...
export default function PositionRow({
  ...
  return (
    <motion.div
      ...
      className="app-card app-card-hover p-4 transition-all"
    >
        ...
        <div className="flex items-center gap-2">
          ...
          {onEdit && (
            <motion.button
              ...
              className="p-2 rounded-lg bg-background-surface border border-border/50 hover:border-border/50 text-text-secondary hover:text-text-primary transition-all"
