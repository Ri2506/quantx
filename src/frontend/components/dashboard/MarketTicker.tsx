        ...
        >
          {tickerData.map((item, index) => {
            ...
            return (
              ...
              className="flex items-center gap-4 px-4 py-2 bg-background-elevated rounded-lg border border-border/50 whitespace-nowrap cursor-pointer hover:border-border/80 transition-all"
            >
                {/* Symbol */}
