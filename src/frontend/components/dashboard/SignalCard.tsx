...
export default function SignalCard({
  ...
  return (
    <motion.div
      ...
      className="app-card app-card-hover p-4 transition-all group"
    >
      {/* Header */}
      ...
      <div className="grid grid-cols-3 gap-3 mb-4">
        {/* Entry */}
        <div className="bg-background-elevated/70 rounded-lg p-3 border border-border/50">
      ...
      <div className="flex items-center gap-2">
        ...
        <Link
          ...
          className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-background-elevated rounded-lg border border-border/50 hover:border-border/50 transition-all group/btn"
        >
