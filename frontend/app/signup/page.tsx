    ...
    <div className="min-h-screen bg-background-primary flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        ...
        <motion.div
          ...
          className="glass-card-neu backdrop-blur-xl rounded-2xl border border-white/[0.04] p-8 shadow-2xl"
        >
              ...
              >
                ...
                <form onSubmit={handleSubmit(onAccountSubmit)} className="space-y-5">
                  ...
                  <div>
                    <label className="flex items-start gap-2 cursor-pointer">
                      <input
                        {...register('terms')}
                        type="checkbox"
                        className="w-4 h-4 mt-1 rounded border-gray-700 bg-background-elevated text-primary focus:ring-2 focus:ring-primary/20"
                      />
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    type="submit"
                    className="w-full flex items-center justify-center gap-2 px-6 py-3 btn-tv-gradient btn-press text-white rounded-xl font-medium shadow-glow-sm hover:shadow-glow-md transition-all"
                  >
                    Continue
              ...
              >
                ...
                <div className="flex gap-4">
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    onClick={() => setStep(1)}
                    className="flex items-center justify-center gap-2 px-6 py-3 bg-background-elevated text-text-primary rounded-xl font-medium border border-white/[0.04] hover:border-gray-700 transition-all"
                  >
                  ...
                  <motion.button
                    ...
                    whileTap={{ scale: 0.98 }}
                    onClick={() => setStep(3)}
                    className="flex-1 flex items-center justify-center gap-2 px-6 py-3 btn-tv-gradient btn-press text-white rounded-xl font-medium shadow-glow-sm hover:shadow-glow-md transition-all"
                  >
                    Continue
                    <ArrowRight className="w-5 h-5" />
                  </motion.button>
              ...
              >
                ...
                <div className="flex gap-4">
                  ...
                  <motion.button
                    ...
                    disabled={isLoading}
                    className="flex-1 flex items-center justify-center gap-2 px-6 py-3 btn-tv-gradient btn-press text-white rounded-xl font-medium shadow-glow-sm hover:shadow-glow-md transition-all disabled:opacity-50"
                  >
                    {isLoading ? (
                      <Loader2 className="w-5 h-5 animate-spin" />
                    ) : (
