          ...
          {type === 'position' ? (
            <>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="100000"
                      className="w-full rounded-lg border border-border/60 bg-main/60 py-3 pl-10 pr-4 text-white placeholder-text-secondary transition focus:border-primary/60 focus:outline-none"
                    />
                  </div>
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="2500"
                    className="w-full rounded-lg border border-border/60 bg-main/60 py-3 px-4 text-white placeholder-text-secondary transition focus:border-primary/60 focus:outline-none"
                  />
                </div>
              ...
              {positionResults && (
                ...
                >
                  <h3 className="mb-4 text-lg font-semibold text-white">Recommended Position</h3>
                  <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div className="rounded-lg bg-background-surface/60 p-4">
                      ...
                      <div className="mt-1 text-2xl font-bold text-white">₹{positionResults.positionSize}</div>
                    </div>
            ...
            <>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  ...
                  <input
                    ...
                    placeholder="500000"
                    className="w-full rounded-lg border border-border/60 bg-main/60 py-3 px-4 text-white placeholder-text-secondary transition focus:border-accent/60 focus:outline-none"
                  />
                </div>
              ...
              {riskResults && (
                ...
                >
                  <h3 className="mb-4 text-lg font-semibold text-white">Risk Analysis</h3>
                  <div className="grid gap-4 md:grid-cols-3">
                    <div className="rounded-lg bg-background-surface/60 p-4">
                      <div className="text-sm text-d-text-muted">Position %</div>
                      <div className="mt-1 text-2xl font-bold text-white">{riskResults.positionPercent}%</div>
