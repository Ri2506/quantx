        ...
        <section className="relative mx-auto max-w-full">
          ...
          <div className="mx-auto max-w-screen-xl gap-12 px-4 py-28 md:px-8">
            <div className="mx-auto max-w-3xl space-y-5 text-center">
              <h1 className="group mx-auto w-fit rounded-3xl border border-border/60 bg-background-surface/70 px-5 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-muted">
                {title}
                <ChevronRight className="ml-2 inline h-4 w-4 transition duration-300 group-hover:translate-x-1" />
              </h1>
              <h2 className="mx-auto text-4xl font-semibold tracking-tight text-white md:text-6xl">
                {subtitle.regular}
              ...
              <div className="flex items-center justify-center gap-x-3">
                <span className="relative inline-block overflow-hidden rounded-full p-[1.5px]">
                  ...
                  <div className="inline-flex h-full w-full items-center justify-center rounded-full bg-background-surface/90 text-sm font-semibold text-white shadow-[0_0_0_1px_rgb(var(--border)/0.6)] backdrop-blur-3xl">
                    <a
                      href={ctaHref}
                      className="inline-flex w-full items-center justify-center rounded-full border border-border/60 bg-main/30 px-8 py-4 text-center transition hover:bg-background-elevated/70 sm:w-auto"
                    >
                      {ctaText}
                    </a>
                  </div>
